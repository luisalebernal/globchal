...
tgt_user, tgt_password, tgt_account, tgt_warehouse, tgt_database, tgt_schema = (targetConnection.get(key) for key in ['username', 'password', 'account', 'warehouse', 'database', 'schema'])
...
df_hired_emp['datetime'] = df_hired_emp['datetime'].replace({np.nan: '1910-01-01T00:00:00Z', '': '1910-01-01T00:00:00Z'})
# print(df_hired_emp)
